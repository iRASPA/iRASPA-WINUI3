...
// Only the atlas sizing and the uniform blocks are present: the ribbon ambient-occlusion bake, its
// debug overlays and the cache key are not ported yet and belong with the bake pass.
