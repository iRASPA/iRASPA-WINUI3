...
{
  _style = axesStyle;
  std::cerr << "Style set " << int(axesStyle);
  switch(axesStyle)
  {
    case RKGlobalAxes::Style::defaultStyle:
      ...
      _centerAmbientColor = RKColor::fromRgb(51,51,51,255);
      _centerDiffuseColor = RKColor::fromRgb(102,178,255,255);
      _centerSpecularColor = RKColor::fromRgb(255,255,255,255);
      _centerShininess = 4.0;

      _axisXAmbientColor = RKColor::fromRgb(51,51,51,255);
      _axisXDiffuseColor = RKColor::fromRgb(102,178,255,255);
      _axisXSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisXShininess = 4.0;

      _axisYAmbientColor = RKColor::fromRgb(51,51,51,255);
      _axisYDiffuseColor = RKColor::fromRgb(102,178,255,255);
      _axisYSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisYShininess = 4.0;

      _axisZAmbientColor = RKColor::fromRgb(51,51,51, 255);
      _axisZDiffuseColor = RKColor::fromRgb(102,178,255,255);
      _axisZSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisZShininess = 4.0;
      break;
    case RKGlobalAxes::Style::thickRGB:
      ...
      _centerAmbientColor = RKColor::fromRgb(51,51,51,255);
      _centerDiffuseColor = RKColor::fromRgb(255,255,255,255);
      _centerSpecularColor = RKColor::fromRgb(255,255,255,255);
      _centerShininess = 4.0;

      _axisXAmbientColor = RKColor::fromRgb(51,51,51,255);
      _axisXDiffuseColor = RKColor::fromRgb(255,0,0,255);
      _axisXSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisXShininess = 4.0;

      _axisYAmbientColor = RKColor::fromRgb(51,51,51, 255);
      _axisYDiffuseColor = RKColor::fromRgb(0,255,0,255);
      _axisYSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisYShininess = 4.0;

      _axisZAmbientColor = RKColor::fromRgb(51,51,51, 255);
      _axisZDiffuseColor = RKColor::fromRgb(0,0,255,255);
      _axisZSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisZShininess = 4.0;
       break;
    case RKGlobalAxes::Style::thick:
      ...
      _axisXAmbientColor = RKColor::fromRgb(51,51,51,255);
      _axisXDiffuseColor = RKColor::fromRgb(255,102,178,255);
      _axisXSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisXShininess = 4.0;

      _axisYAmbientColor = RKColor::fromRgb(51,51,51,255);
      _axisYDiffuseColor = RKColor::fromRgb(178,255,102,255);
      _axisYSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisYShininess = 4.0;
    ...
    case RKGlobalAxes::Style::beamArrowRGB:
      ...
      _centerAmbientColor = RKColor::fromRgb(51,51,51,255);
      _centerDiffuseColor = RKColor::fromRgb(255,255,0,255);
      _centerSpecularColor = RKColor::fromRgb(255,255,255,255);
      _centerShininess = 4.0;
    ...
    case RKGlobalAxes::Style::squashedRGB:
      ...
      _centerAmbientColor = RKColor::fromRgb(051,51,51,255);
      _centerDiffuseColor = RKColor::fromRgb(255,255,255,255);
      _centerSpecularColor = RKColor::fromRgb(255,255,255,255);
      _centerShininess = 4.0;
    ...
    case RKGlobalAxes::Style::squashed:
      ...
      _axisXAmbientColor = RKColor::fromRgb(5151,51,255);
      _axisXDiffuseColor = RKColor::fromRgb(255,102,178,255);
      _axisXSpecularColor = RKColor::fromRgb(255,255,255,255);
      _axisXShininess = 4.0;
...
BinaryArchive &operator<<(BinaryArchive &stream, const std::shared_ptr<RKGlobalAxes> &axes)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<RKGlobalAxes> &axes)
{
