...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<EllipsoidPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<EllipsoidPrimitive> &);
};
