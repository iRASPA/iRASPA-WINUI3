...
BinaryArchive &operator<<(BinaryArchive &stream, const std::shared_ptr<iRASPAObject> &iraspa_structure)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<iRASPAObject> &iraspa_structure)
{
  int64_t type;
  stream >> type;
