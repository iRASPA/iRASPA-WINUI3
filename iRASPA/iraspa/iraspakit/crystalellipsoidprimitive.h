...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<CrystalEllipsoidPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<CrystalEllipsoidPrimitive> &);
};
