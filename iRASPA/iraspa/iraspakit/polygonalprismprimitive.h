...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<PolygonalPrismPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<PolygonalPrismPrimitive> &);
};
