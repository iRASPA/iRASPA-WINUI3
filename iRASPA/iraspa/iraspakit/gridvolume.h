...
public:
  ...
  RKColor unitCellDiffuseColor() const override {return _unitCellDiffuseColor;}
...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<GridVolume> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<GridVolume> &);
};
