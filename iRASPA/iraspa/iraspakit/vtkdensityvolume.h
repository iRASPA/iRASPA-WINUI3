...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<VTKDensityVolume> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<VTKDensityVolume> &);
};
