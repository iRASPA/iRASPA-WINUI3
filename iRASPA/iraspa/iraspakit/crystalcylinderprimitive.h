...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<CrystalCylinderPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<CrystalCylinderPrimitive> &);
};
