...
class ProteinCrystal: public Structure, public ProteinRibbonMixin, public SpaceGroupViewer, public SpaceGroupEditor,
...
public:
  ...
  // A protein crystal holding nothing but solvent is the solvent of a protein crystal. It is the
  // same class either way, as it is in Cocoa, so which of the two it is comes from the atoms.
  ObjectType structureType() override final
  {
    return containsOnlySolventAtoms() ? ObjectType::proteinCrystalSolvent : ObjectType::proteinCrystal;
  }
  ...
  // RKRenderObject
  // ===============================================================================================
  bool isPresentedAsRibbonOnly() const override final
  {
    return ProteinRibbonMixin::drawRibbon() && ProteinRibbonMixin::ribbonNumberOfVertices() > 0
        && !Structure::hasVisibleAtoms();
  }
  ...
  RKColor unitCellDiffuseColor() const override final {return _unitCellDiffuseColor;}
  ...
  void setUnitCellDiffuseColor(RKColor value) override final {_unitCellDiffuseColor = value;}
  ...
  RKColor adsorptionSurfaceFrontSideAmbientColor() const override final {return _adsorptionSurfaceFrontSideAmbientColor;}
  RKColor adsorptionSurfaceFrontSideDiffuseColor() const override final {return _adsorptionSurfaceFrontSideDiffuseColor;}
  RKColor adsorptionSurfaceFrontSideSpecularColor() const override final {return _adsorptionSurfaceFrontSideSpecularColor;}
  ...
  RKColor adsorptionSurfaceBackSideAmbientColor() const override final {return _adsorptionSurfaceBackSideAmbientColor;}
  RKColor adsorptionSurfaceBackSideDiffuseColor() const override final {return _adsorptionSurfaceBackSideDiffuseColor;}
  RKColor adsorptionSurfaceBackSideSpecularColor() const override final {return _adsorptionSurfaceBackSideSpecularColor;}
  ...
  RKByteArray data() const override final {return _data;}
  ...
  void setAdsorptionSurfaceFrontSideAmbientColor(RKColor color) override final {_adsorptionSurfaceFrontSideAmbientColor = color;}
  void setAdsorptionSurfaceFrontSideDiffuseColor(RKColor color) override final {_adsorptionSurfaceFrontSideDiffuseColor = color;}
  void setAdsorptionSurfaceFrontSideSpecularColor(RKColor color) override final {_adsorptionSurfaceFrontSideSpecularColor = color;}
  ...
  void setAdsorptionSurfaceBackSideAmbientColor(RKColor color) override final {_adsorptionSurfaceBackSideAmbientColor = color;}
  void setAdsorptionSurfaceBackSideDiffuseColor(RKColor color) override final {_adsorptionSurfaceBackSideDiffuseColor = color;}
  void setAdsorptionSurfaceBackSideSpecularColor(RKColor color) override final {_adsorptionSurfaceBackSideSpecularColor = color;}
...
protected:
  ...
  simd_quatd ribbonOrientation() const override { return _orientation; }
  double3 ribbonBoundingBoxCenter() const override { return boundingBox().center(); }
