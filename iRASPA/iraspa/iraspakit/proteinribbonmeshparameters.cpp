...
ProteinRibbonMeshParameters ProteinRibbonMeshParameters::effectiveForStructure(int atomCount, int residueCount) const
{
  (void)atomCount;
  (void)residueCount;
  return clamped();
...
ProteinRibbonMeshParameters ProteinRibbonMeshParameters::forImportedStructure(int atomCount, int residueCount)
{
  (void)atomCount;
  (void)residueCount;
