...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<GaussianCubeVolume> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<GaussianCubeVolume> &);
};
