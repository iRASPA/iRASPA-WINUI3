...
ProjectTreeController::ProjectTreeController(): _hiddenRootNode(std::make_shared<ProjectTreeNode>(RKString("hidden root node"),true,false))
{
  std::shared_ptr<ProjectTreeNode> rootGalleryProjects = std::make_shared<ProjectTreeNode>(RKString("GALLERY"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
  std::shared_ptr<ProjectTreeNode> emptyLocalProjects1 = std::make_shared<ProjectTreeNode>(RKString("  "), false, false);
  std::shared_ptr<ProjectTreeNode> rootLocalProjects = std::make_shared<ProjectTreeNode>(RKString("LOCAL PROJECTS"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
  std::shared_ptr<ProjectTreeNode> emptyLocalProjects2 = std::make_shared<ProjectTreeNode>(RKString("  "), false, false);
  std::shared_ptr<ProjectTreeNode> rootIcloudProjects = std::make_shared<ProjectTreeNode>(RKString("DATABASES PUBLIC"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
  ...
  _galleryProjects = std::make_shared<ProjectTreeNode>(RKString("Gallery"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
  _localProjects = std::make_shared<ProjectTreeNode>(RKString("Local Projects"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
  _icloudProjects = std::make_shared<ProjectTreeNode>(RKString("Databases Public"), std::make_shared<iRASPAProject>(std::make_shared<ProjectGroup>()), false, false);
...
BinaryArchive &operator<<(BinaryArchive& stream, const std::shared_ptr<ProjectTreeController>& controller)
{
...
BinaryArchive &operator>>(BinaryArchive& stream, std::shared_ptr<ProjectTreeController>& controller)
{
