...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<MolecularCrystal> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<MolecularCrystal> &);
};
