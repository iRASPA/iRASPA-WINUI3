...
private:
    ...
    friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<ProjectTreeController> &);
    friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<ProjectTreeController> &);
};
