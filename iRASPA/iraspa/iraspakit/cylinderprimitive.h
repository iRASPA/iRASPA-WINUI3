...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<CylinderPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<CylinderPrimitive> &);
};
