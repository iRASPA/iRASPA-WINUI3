...
BinaryArchive &operator<<(BinaryArchive &stream, const std::shared_ptr<VASPDensityVolume> &volume)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<VASPDensityVolume> &volume)
{
  ...
  int64_t magicNumber;
  stream >> magicNumber;
  if(magicNumber != int64_t(0x6f6b6198))
  {
