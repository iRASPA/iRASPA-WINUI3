...
BinaryArchive &operator<<(BinaryArchive &stream, const std::shared_ptr<Primitive> &primitive)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<Primitive> &primitive)
{
  ...
  if(versionNumber >= 2)
  {
    int64_t magicNumber;
    stream >> magicNumber;
    if(magicNumber != int64_t(0x6f6b6188))
    {
