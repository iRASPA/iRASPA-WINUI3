...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<VASPDensityVolume> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<VASPDensityVolume> &);
};
