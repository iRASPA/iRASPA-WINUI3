...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<CrystalPolygonalPrismPrimitive> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<CrystalPolygonalPrismPrimitive> &);
};
