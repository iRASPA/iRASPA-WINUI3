...
public:
  ...
  virtual void setPrimitiveFrontSideAmbientColor(RKColor color) = 0;
  virtual void setPrimitiveFrontSideDiffuseColor(RKColor color) = 0;
  virtual void setPrimitiveFrontSideSpecularColor(RKColor color) = 0;
  ...
  virtual void setPrimitiveBackSideAmbientColor(RKColor color) = 0;
  virtual void setPrimitiveBackSideDiffuseColor(RKColor color) = 0;
  virtual void setPrimitiveBackSideSpecularColor(RKColor color) = 0;
