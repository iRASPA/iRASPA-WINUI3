...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<RASPADensityVolume> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<RASPADensityVolume> &);
};
