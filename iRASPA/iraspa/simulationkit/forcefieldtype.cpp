...
ForceFieldType::ForceFieldType(RKString forceFieldStringIdentifier, int64_t atomicNumber, double2 potentialParameters, double mass, double userDefinedRadius, bool editable)
{
...
BinaryArchive &operator<<(BinaryArchive &stream, const ForceFieldType &forcefieldType)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, ForceFieldType &forcefieldType)
{
