...
{
public:
  SKPOSCARLegacyParser(const std::filesystem::path &, bool onlyAsymmetricUnitCell, bool asMolecule, CharacterSet charactersToBeSkipped, LogReporting *log);
  SKPOSCARLegacyParser(RKString, bool onlyAsymmetricUnitCell, bool asMolecule, CharacterSet charactersToBeSkipped, LogReporting *log);
