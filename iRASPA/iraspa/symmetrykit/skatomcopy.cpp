...
BinaryArchive &operator<<(BinaryArchive &stream, const std::shared_ptr<SKAtomCopy> &copy)
{
...
BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<SKAtomCopy> &copy)
{
