...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<SKBondSetController> &);
  friend BinaryArchive &operator>>(BinaryArchive &stream, std::shared_ptr<SKBondSetController>& controller);
};
