...
private:
  ...
  friend BinaryArchive &operator<<(BinaryArchive & stream, const std::vector<std::shared_ptr<SKAsymmetricBond>>& val);
  friend BinaryArchive &operator>>(BinaryArchive & stream, std::vector<std::shared_ptr<SKAsymmetricBond>>& val);

  friend BinaryArchive &operator<<(BinaryArchive & stream, const std::vector<std::shared_ptr<SKBond>>& val);
  friend BinaryArchive &operator>>(BinaryArchive & stream, std::vector<std::shared_ptr<SKBond>>& val);

  friend BinaryArchive &operator<<(BinaryArchive &, const std::shared_ptr<SKAsymmetricBond> &);
  friend BinaryArchive &operator>>(BinaryArchive &, std::shared_ptr<SKAsymmetricBond> &);
};
